...
DefinitionBlock (__FILE__, "SSDT", 5, "RKCP  ", "PCIE34L0", 2)
{
  Scope (\_SB_)
  {
    Device (PCI0) {
      ...
      Method (_CRS, 0, Serialized) {
        Name (RBUF, ResourceTemplate () {
          ...
          QWordMemory (ResourceProducer, PosDecode, MinFixed, MaxFixed, NonCacheable, ReadWrite,
            ...
            0x0000000910000000,   // Range Minimum
            0x000000093FFEFFFF,   // Range Maximum
          ...
          QWordIO (ResourceProducer, MinFixed, MaxFixed, PosDecode, EntireRange,
            ...
            0x000000093FFF0000,   // Translation Offset
            0x10000,              // Length
          )
        })
        return (RBUF)
      ...
      Device (RES0) {
        ...
        Name (_CRS, ResourceTemplate () {
          QWordMemory (ResourceProducer, PosDecode, MinFixed, MaxFixed, NonCacheable, ReadWrite,
            ...
            0x000000090FFFFFFF,   // Range Maximum
            0x0000000000000000,   // Translation Offset
            0x0000000010000000,   // Length
          )
          QWordMemory (ResourceProducer, PosDecode, MinFixed, MaxFixed, NonCacheable, ReadWrite,
            0x0000000000000000,   // Granularity
            0x0000000A40000000,   // Range Minimum
            0x0000000A403FFFFF,   // Range Maximum
            0x0000000000000000,   // Translation Offset
