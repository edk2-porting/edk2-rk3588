...
{
  /* Status indicator */
  GpioPinWrite(1, GPIO_PIN_PB5, FALSE);
  GpioPinSetDirection(1, GPIO_PIN_PB5, GPIO_PIN_OUTPUT);
}
...
VOID
    ...
    PlatformSetStatusLed(
        IN BOOLEAN Enable)
{
  GpioPinWrite(1, GPIO_PIN_PB5, Enable);
}
        ...
        IN UINT32 CompatMode)
{
  STATIC CONST EFI_GUID MainlineDtbFileGuid = {
      ...
      0xa10f,
      0x49a7,
      {0x85, 0xe9, 0x02, 0x5d, 0x19, 0x66, 0xb3, 0x43}};
