  ...
  )
{
  ...
  PhyUpdateBits(Hdptx, CMN_REG005E, ROPLL_SDM_EN_MASK,
  ...
  PhyUpdateBits(Hdptx, CMN_REG0086, PLL_PCG_POSTDIV_SEL_MASK,
  		  PLL_PCG_POSTDIV_SEL(Cfg->Pms_Sdiv));
  
  PhyUpdateBits(Hdptx, CMN_REG0086, PLL_PCG_CLK_SEL_MASK,
  		  PLL_PCG_CLK_SEL(8));
