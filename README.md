...
| Mekotronics R58 Mini | Four display outputs, so all four video ports are in use: HDMI0 on VP0, the DisplayPort connector on VP1, HDMI1 on VP2, and USB-C DisplayPort on VP3. VP3 is the weakest of the four (2048x1536, 200 MHz pixel clock), so the Type-C output is limited to about 1080p60 while the other three are not. |
